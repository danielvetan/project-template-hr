      ...
      menu: [
        {
          ...
          subMenus: [
            ...
            { menuValue: 'Avatar', route: routes.avatar, base: 'avatar' },
            { menuValue: 'Badges', route: routes.badges, base: 'badges' },
            {
              menuValue: 'Buttons',
            ...
            { menuValue: 'Cards', route: routes.cards, base: 'cards' },
            {
              menuValue: 'Carousel',
            ...
            { menuValue: 'Grid', route: routes.grid, base: 'grid' },
            { menuValue: 'Images', route: routes.images, base: 'images' },
            {
              menuValue: 'Lightbox',
              route: routes.lightBox,
              base: 'light-box',
            },
            { menuValue: 'Media', route: routes.media, base: 'media' },
            { menuValue: 'Modals', route: routes.modal, base: 'modal' },
            {
              menuValue: 'Offcanvas',
            ...
            { menuValue: 'Tabs', route: routes.tabs, base: 'tabs' },
            { menuValue: 'Toasts', route: routes.toasts, base: 'toasts' },
            {
              menuValue: 'Tooltip',
            ...
            { menuValue: 'Videos', route: routes.video, base: 'video' },
          ],
        },
        {
          menuValue: 'Elements',
          ...
          materialicons: 'people',
          subMenus: [
            { menuValue: 'Ribbon', route: routes.ribbon, base: 'ribbon' },
            {
              menuValue: 'Clipboard',
        ...
        },
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Form Upload',
              route: routes.fileUpload,
              base: 'file-upload',
            },
            {
              menuValue: 'Material Select',
              route: routes.mat_select,
              base: 'mat-select',
            },
          ],
        },
